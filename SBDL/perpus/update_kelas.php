...
<body>
	<nav>
		<ul class="kiri">
			<li><a href="index.php">UPDATE KELAS</a></li>
		</ul>
	</nav>
	<div class="sidebar">
		<ul>
	...
	<div class="main">
		<div class="isimain">
			...
			$id = $_GET['id_kelas'];
			$link = koneksi_db();
			$sql = "SELECT * FROM jenis WHERE id_kelas='$id'";
			$res = mysqli_query($link,$sql);

			if (mysqli_num_rows($res)==1) {
				$data = mysqli_fetch_array($res);
			?>
			<form action="proses_update_jenis.php?id_kelas=<?=$data['id_kelas']; ?>" method="POST">
				<h1><font size="5">Edit Kelas : </font></h1><br>
				<table width="430px">
