...
<body>
	...
	<div class="main">
		<div class="isimain">
			<form method="POST" enctype="multipart/form-data">
				<h1><font size="5" style="text-align: left;">Tambah Data Libur : </font></h1><br>
				<table width="150px" border="0">
				
					<tr>
						<td>Tanggal</td><td>:</td>
						<td>
							<input type="date" name="tanggal"  maxlength="50" autocomplete required>
						</td>
					</tr>
					<tr>
						<td>Nama</td><td>:</td>
  ...
  $nama  = $_POST['nama'];
			...
			$sql = "INSERT INTO libur (id,tanggal,nama) VALUES ('$id','$tanggal', '$nama')";
			$link = koneksi_db();
