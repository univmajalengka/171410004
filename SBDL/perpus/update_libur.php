...
if($_SESSION['status'] !="login"){
  header("location:login.php");
	...
	<title>Update Data Libur</title>
</head>
<body>
	<nav>
		<ul class="kiri">
			<li><a href="index.php">UPDATE DATA LIBUR</a></li>
		</ul>
	</nav>
	<div class="sidebar">
		<ul>
	...
	<div class="main">
		<div class="isimain">
			...
			$id = $_GET['id'];
			$link = koneksi_db();
			$sql = "SELECT * FROM libur WHERE id='$id'";
			$res = mysqli_query($link,$sql);

			if (mysqli_num_rows($res)==1) {
				$data = mysqli_fetch_array($res);
			?>
			<form action="proses_update_libur.php?id=<?=$data['id']; ?>" method="POST">
