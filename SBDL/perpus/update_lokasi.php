...
if($_SESSION['status'] !="login"){
  header("location:login.php");
	...
	<title>Update Data Lokasi</title>
</head>
<body>
	<nav>
		<ul class="kiri">
			<li><a href="index.php">UPDATE LOKASI</a></li>
		</ul>
	</nav>
	<div class="sidebar">
		<ul>
	...
	<div class="main">
		<div class="isimain">
			...
			?>
			<form action="proses_update_lokasi.php?id_lokasi=<?=$data['id_lokasi']; ?>" method="POST">
				<h1><font size="5">Edit Lokasi : </font></h1><br>
				<table width="430px">
